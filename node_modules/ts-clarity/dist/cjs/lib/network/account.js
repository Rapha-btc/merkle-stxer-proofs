...
async function getAccountNonces(address, _options) {
...
async function getAccountBalances(address, _options) {
    const options = (0, request_js_1.mergeDefaultExtendedApiRequestOptions)(_options);
